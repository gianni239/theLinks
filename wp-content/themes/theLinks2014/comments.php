...
<div id="respond">
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform" class="form-horizontal login" role="form">
		...
		<?php else : ?>
			...
			<div class="form-group">
				<label for="author" class="col-md-3 control-label">Name <?php if ($req) echo "*"; ?></label>
				<div class="col-md-9">
			...
			<div class="form-group">
				<label for="email" class="col-md-3 control-label">Mail (will not be published) <?php if ($req) echo "*"; ?></label>
				<div class="col-md-9">
